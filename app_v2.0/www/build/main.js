...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__app_component__ = __webpack_require__(362);
...
var MyApp = (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/Users/vjlockel/Documents/PRO/APPLICATIONS/BENOO/APP_BENOO/app_v2.0/src/app/app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"/Users/vjlockel/Documents/PRO/APPLICATIONS/BENOO/APP_BENOO/app_v2.0/src/app/app.html"*/
        }),
...
var EntrepreneurOrderPage = (function () {
    ...
    EntrepreneurOrderPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-entrepreneur-order',template:/*ion-inline-start:"/Users/vjlockel/Documents/PRO/APPLICATIONS/BENOO/APP_BENOO/app_v2.0/src/pages/entrepreneur-order/entrepreneur-order.html"*/'<!--\n  Generated template for the EntrepreneurOrderPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n    <ion-navbar color="primary">\n      <ion-title>Commandes en cours <span *ngIf="orders && orders.length > 0">({{orders.length}})</span></ion-title>\n    </ion-navbar>\n  </ion-header>\n\n\n<ion-content no-padding>\n  <div *ngIf="orders && orders.length > 0" no-padding>\n    <ion-list *ngFor="let order of orders">\n      <ion-card>\n          <div class="card-title" ><h3>Commande du {{order.date}} (#{{order.id}})</h3></div>\n            <div class="order-info">\n                <p><b>Détail :</b></p>\n                <ul [innerHTML]="order.detail"></ul>\n                <p><b>Total :</b> {{order.total}} Fcfa</p>\n                <p><b>Statut :</b>\n                  {{order.statusLibelle}}\n                </p>\n            </div>  \n              \n          <button ion-button large block color="success" (click)="confirmOrder(order.id)" >Confirmer la réception</button>\n\n      </ion-card>        \n    </ion-list>\n  </div>\n      \n  <div *ngIf="orders && orders.length == 0" no-padding>\n    <p>Pas de commandes enregistrées actuellement.</p>\n  </div>\n\n</ion-content>'/*ion-inline-end:"/Users/vjlockel/Documents/PRO/APPLICATIONS/BENOO/APP_BENOO/app_v2.0/src/pages/entrepreneur-order/entrepreneur-order.html"*/,
        }),
...
var EntrepreneurCategoryPage = (function () {
    ...
    EntrepreneurCategoryPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_4__angular_core__["m" /* Component */])({
            selector: 'page-entrepreneur-category',template:/*ion-inline-start:"/Users/vjlockel/Documents/PRO/APPLICATIONS/BENOO/APP_BENOO/app_v2.0/src/pages/entrepreneur-category/entrepreneur-category.html"*/'<!--\n  Generated template for the EntrepreneurCategoryPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n    <ion-navbar color="primary">\n        <ion-title>Achats</ion-title>\n        <ion-buttons end>\n            <button ion-button [navPush]="entCartPage" [navParams]="entCartObj">\n              <ion-icon name="cube"></ion-icon>&nbsp;\n              <span *ngIf="entCartObj">{{entCartObj.totalProduct}}</span>\n            </button>\n          </ion-buttons>    \n      </ion-navbar>\n  </ion-header>\n  \n\n<ion-content no-padding>\n    <ion-list no-padding>\n        <ion-row no-padding>\n            <ion-col  *ngFor="let menu of menuData" col-6>\n              <ion-card no-padding [navPush]="pageProduct" [navParams]=\'{typeId : menu.id, typeName : menu.title}\'>\n                <img src="./assets/imgs/{{menu.picture}}" alt="">\n                <div class="card-title" >{{menu.title}}</div>\n              </ion-card>\n            </ion-col>\n          </ion-row>\n      </ion-list>\n</ion-content>\n'/*ion-inline-end:"/Users/vjlockel/Documents/PRO/APPLICATIONS/BENOO/APP_BENOO/app_v2.0/src/pages/entrepreneur-category/entrepreneur-category.html"*/,
        }),
